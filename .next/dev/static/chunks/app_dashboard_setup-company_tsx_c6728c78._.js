        ...
        "SetupCompanyPage.useEffect": ()=>{
            async function fetchCompany() {
                try {
                    ...
                    if (payload?.company) {
                        setCompany({
                            "SetupCompanyPage.useEffect.fetchCompany": (prev)=>({
                                    ...prev,
                                    ...payload.company,
                        ...
                        }["SetupCompanyPage.useEffect.fetchCompany"]);
                    }
                } catch (err) {
                    console.error(err);
...
_s(SetupCompanyPage, "ssioZGc874fSApBZedmzd+cdjhg=");
_c = SetupCompanyPage;
var _c;
...
//# sourceMappingURL=app_dashboard_setup-company_tsx_c6728c78._.js.map