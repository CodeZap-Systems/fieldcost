...
function LoginPage() {
    ...
    const [sessionError, setSessionError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
            ...
            const checkExistingSession = {
                "LoginPage.useEffect.checkExistingSession": async ()=>{
                    try {
                        ...
                        const { data, error: sessionError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.getSession();
                        if (sessionError) {
            ...
            try {
                ...
                if (companyRes.ok) {
                    ...
                    if (Array.isArray(companies) && companies.length > 0) {
                        ...
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$companySwitcher$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["persistActiveCompanyId"])(String(companies[0].id));
                    }
                }
            } catch (err) {
...
_s(LoginPage, "sS2AYVGQHwHHfBISF4vkEPa/n94=", false, function() {
    return [
