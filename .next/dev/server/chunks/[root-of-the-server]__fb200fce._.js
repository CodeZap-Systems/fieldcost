...
async function saveStoredCompanyProfile(profile) {
    const store = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dataStore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["readStore"])(FILE_NAME, {});
...
async function GET(req) {
    ...
    try {
        ...
        if (data) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$companyProfileStore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["saveStoredCompanyProfile"])(normalizeProfile(data, userId));
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                company: data
            });
        }
        const fallback = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$companyProfileStore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getStoredCompanyProfile"])(userId);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function PUT(req) {
    ...
    try {
        ...
        const storedProfile = normalizeProfile(data ?? payload, userId);
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$companyProfileStore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["saveStoredCompanyProfile"])(storedProfile);
        if (userId) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fb200fce._.js.map