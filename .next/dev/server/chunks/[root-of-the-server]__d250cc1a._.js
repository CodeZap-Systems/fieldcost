    ...
    try {
        ...
        if (lineError) {
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseErrors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isSchemaCacheError"])(lineError)) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseServer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseServer"].from('invoices').delete().eq('id', invoice.id).catch(()=>undefined);
                const offlineResponse = await persistOfflineInvoice({
                    userId,
                    customerId,
                    customerName,
