...
async function GET(req) {
    ...
    const query = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseServer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseServer"].from('crew_members').select('*').order('name', {
        ascending: true
    });
...
async function POST(req) {
    ...
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseServer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseServer"].from('crew_members').insert([
        payload
    ]).select();
    if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__801e55bf._.js.map