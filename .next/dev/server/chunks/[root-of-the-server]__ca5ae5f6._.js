...
async function GET(req) {
    ...
    try {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseServer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseServer"].from('tasks').select('*, project:projects(name)').eq('user_id', userId).order('id', {
            ascending: false
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ca5ae5f6._.js.map