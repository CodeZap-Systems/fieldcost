...
async function GET(req) {
    try {
        ...
        if (isDemoCompany) {
            let query = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseServer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseServer"].from('projects').select('*').eq('company_id', companyId);
            const { data, error } = await query.limit(PROJECT_LIMIT);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(!error && data ? data : []);
        } else {
            // Live company: require user_id match for security
            if (userId && userId !== 'demo-user') {
                // For authenticated real users: strict user+company validation
                let query = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseServer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseServer"].from('projects').select('*').eq('user_id', userId).eq('company_id', companyId);
                const { data, error } = await query.limit(PROJECT_LIMIT);
                if (!error && data) {
                    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(data.map((p)=>({
                            ...p,
...
async function POST(req) {
    try {
        ...
        try {
            // Check project limit
            const { count, error: countError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseServer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseServer"].from('projects').select('*', {
                count: 'exact',
                head: true
            }).eq('user_id', userId).eq('company_id', validCompanyId);
            if (!countError && count !== null && count >= PROJECT_LIMIT) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    error: `Project limit reached (${PROJECT_LIMIT})`
                }, {
                    status: 400
                });
            }
            ...
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseServer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseServer"].from('projects').insert([
                payload
            ]).select();
            if (error) {
...
async function PATCH(req) {
    ...
    try {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseServer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseServer"].from('projects').update(fields).eq('id', id).eq('user_id', userId).eq('company_id', validCompanyId).select();
...
async function DELETE(req) {
    ...
    try {
        const { companyId: validCompanyId } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$companyContext$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCompanyContext"])(userId, companyId);
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseServer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseServer"].from('projects').delete().eq('id', id).eq('user_id', userId).eq('company_id', validCompanyId);
        if (error) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: error.message
        }, {
            status: 500
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a1efbbf3._.js.map