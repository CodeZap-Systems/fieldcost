    ...
    for (const inv of invoices){
        ...
        const drawLine = (text, options)=>{
            ...
            page.drawText(text, {
                ...
                color: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdf$2d$lib$2f$es$2f$api$2f$colors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["rgb"])(color[0], color[1], color[2])
            });
            y -= size + 6;
        };
        drawLine(company?.name || "FieldCost", {
            size: 18,
            bold: true
        });
        ...
        if (company?.address_line1) drawLine(company.address_line1, {
            color: [
                0.35,
                0.35,
                0.35
        ...
        if (company?.address_line2) drawLine(company.address_line2, {
            color: [
                0.35,
                0.35,
                0.35
        ...
        y -= 8;
        drawLine(`Invoice #: ${inv.invoice_number || `#${inv.id}`}`, {
            size: 12,
            bold: true
        });
        ...
        for (const line of inv.line_items || []){
            ...
            if (line.project) drawLine(`Project: ${line.project}`, {
                size: 9,
                color: [
                    0.35,
                    0.35,
            ...
            if (line.note && template === "detailed") drawLine(`Note: ${line.note}`, {
                size: 9,
                color: [
                    0.35,
                    0.35,
        ...
        y -= 8;
        drawLine(`Total: ${formatter.format(inv.amount ?? 0)}`, {
            size: 14,
            bold: true
        });
        if (template === "detailed" && inv.description) {
            drawLine(inv.description, {
                size: 10
            });
        }
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__55be4824._.js.map