...
async function GET(req) {
    ...
    const query = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseServer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseServer"].from('budgets').select('*').eq('project_id', projectId);
...
async function POST(req) {
    ...
    const { project_id, planned_amount, actual_amount, user_id: incomingUserId } = body;
    ...
    const { data: updated, error: updateError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseServer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseServer"].from('budgets').update({
        planned_amount,
        actual_amount
    }).eq('project_id', project_id).eq('user_id', userId).select().maybeSingle();
    if (updateError) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c3aa4ed6._.js.map