...
async function GET(req) {
    try {
        ...
        try {
            const { data: company, error: companyError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseServer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseServer"].from('company_profiles').select('is_demo').eq('id', companyId).maybeSingle(); // Use maybeSingle to handle null gracefully
            if (companyError) {
        ...
        if (isDemoCompany) {
            ...
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseServer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseServer"].from('items').select('*').eq('company_id', companyId);
            if (error) {
            ...
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseServer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseServer"].from('items').select('*').eq('user_id', userId).eq('company_id', companyId);
            if (error) {
...
async function POST(req) {
    try {
        ...
        try {
            ...
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseServer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseServer"].from('items').insert([
                payload
            ]).select();
            if (error) {
...
async function PATCH(req) {
    try {
        ...
        try {
            ...
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseServer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseServer"].from('items').update(fields).eq('id', id).eq('user_id', userId).eq('company_id', validCompanyId).select();
...
async function DELETE(req) {
    try {
        ...
        try {
            const { companyId: validCompanyId } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$companyContext$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCompanyContext"])(userId, companyId);
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseServer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseServer"].from('items').delete().eq('id', id).eq('user_id', userId).eq('company_id', validCompanyId);
            if (error) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: error.message
            }, {
                status: 500
...
//# sourceMappingURL=%5Broot-of-the-server%5D__43a19a3b._.js.map