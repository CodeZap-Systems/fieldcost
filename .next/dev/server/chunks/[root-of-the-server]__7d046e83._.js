...
async function GET(req) {
    ...
    try {
        ...
        const [tasksCount, projectsCount, invoicesCount, customersCount, itemsCount] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseServer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseServer"].from('tasks').select('*', {
                count: 'exact',
                head: true
            }).eq('user_id', userId),
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseServer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseServer"].from('projects').select('*', {
                count: 'exact',
                head: true
            }).eq('user_id', userId),
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseServer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseServer"].from('invoices').select('id, amount', {
                count: 'exact'
            }).eq('user_id', userId),
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseServer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseServer"].from('customers').select('*', {
                count: 'exact',
                head: true
            }).eq('user_id', userId),
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseServer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseServer"].from('items').select('id, price, stock_in', {
                count: 'exact'
            }).eq('user_id', userId)
        ]);
        ...
        const totalInvoiceAmount = invoicesData.reduce((sum, inv)=>sum + (inv.amount || 0), 0);
        const totalInventoryValue = itemsData.reduce((sum, item)=>sum + (item.price || 0) * (item.stock_in || 0), 0);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7d046e83._.js.map