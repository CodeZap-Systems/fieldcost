      ...
      <form onSubmit={handleSubmit} className="max-w-4xl mx-auto space-y-8">
        <header className="space-y-2">
          ...
          <p className="text-gray-600 max-w-2xl">
            Capture company identity, branding, and ERP preferences so invoices, exports, and logins all use the
            right context.
          </p>
        ...
        <section className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-4">
          <div>
            ...
            <p className="text-sm text-gray-500">Display on invoices to meet compliance requirements.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <input
              className="border rounded-lg p-3"
        ...
        <section className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-4">
          <div>
            <h2 className="text-xl font-semibold">ERP connections</h2>
